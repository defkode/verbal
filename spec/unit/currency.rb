...
describe Verbal::Currency do
  ...
  it 'should return correct string' do
    ...
    Verbal::Currency.to_words(1_000_001_00, 'CZK').should == 'milion jeden koron czeskich zero halerzy'
    Verbal::Currency.to_words(1_05, 'EUR').should         == 'jedno euro pięć eurocentów'
    Verbal::Currency.to_words(500_02, 'RUB').should       == 'pięćset rubli dwie kopiejki'
  end
