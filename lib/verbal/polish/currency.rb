  ...
  module Polish
     module Currency
      ...
      def to_words(value, symbol = 'PLN')
        ...
        "#{Verbal::Polish::Numbers.to_words(value / 100, CURRENCIES[symbol][2][0])} #{CURRENCIES[symbol][0][Verbal::Polish::Numbers.variation(value / 100)]}" + " " + "#{Verbal::Polish::Numbers.to_words(value % 100, CURRENCIES[symbol][2][1])} #{CURRENCIES[symbol][1][Verbal::Polish::Numbers.variation(value % 100)]}"
      end
